...
{
    public class ControllerTypeMapping : EntityMapping<ControllerType>
    {
        public ControllerTypeMapping() : base("MC_CONTROLLER_TYPE")
        {
            ...
            }, action => { action.OneToMany(x => { x.Class(typeof(Controller)); }); });
        }
    }
}
